#!/usr/bin/env bash
# Tests for actions/go-tooling/scripts/resolve-version.sh
...
# ============================================================
test_suite "read_version_from_go_mod"
# ============================================================

result="$(echo 'module example.com/mymod
...
require ()' | read_version_from_go_mod)"
assert_eq "1.22" "${result}" "reads 2-part version from go.mod"

assert_failure "fails on go.mod without go directive" bash -c '
  source "'"${ACTION_DIR}/scripts/resolve-version.sh"'"
  echo "module example.com" | read_version_from_go_mod
'

result="$(echo 'module test
go 1.21.5
toolchain go1.22.0' | read_version_from_go_mod)"
assert_eq "1.21.5" "${result}" "takes first go directive, not toolchain"

# ============================================================
test_suite "read_go_version_from_file"
# ============================================================
...
assert_eq "1.26.2" "${result}" "reads from go.mod file"
...
# ============================================================
test_suite "resolve_go_version (explicit)"
# ============================================================
...
# ============================================================
test_suite "resolve_go_version (strips go prefix)"
# ============================================================
...
# ============================================================
test_suite "resolve_go_version (from go.mod)"
# ============================================================
...
# ============================================================
test_suite "resolve_go_version (darwin arm64 URL)"
# ============================================================
...
# ============================================================
test_suite "resolve_go_version (windows zip)"
# ============================================================
...
# Cleanup
unset INPUT_GO_VERSION INPUT_GO_VERSION_FILE INPUT_TOKEN RUNNER_OS RUNNER_ARCH
